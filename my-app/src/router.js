...
import Report_member from '@/components/Report_member.vue'
import Report_sell from '@/components/Report_sell.vue'
import Report_buys from '@/components/Report_buys.vue'
import Report_log_login from '@/components/Report_log_login.vue'
...
export default new Router({
  ...
  routes: [
    ...
    {path: '/Report_member',name: 'Report_member',component: Report_member},
    {path: '/Report_sell',name: 'Report_sell',component: Report_sell},
    {path: '/Report_buys',name: 'Report_buys',component: Report_buys},
    {path: '/Report_log_login',name: 'Report_log_login',component: Report_log_login},
